...
│   └── *.html                    One file per article (27 posts), static TOC in the markup
...
├── games/
│   ├── index.html                Games hub — 67 games in 7 categories, filter, and the
