...
(function () {
  ...
  function setStatus(text, cls) {
    // #api-status is a live region (see initStatusLive). Rewriting it with the
  ...
  /* The status line carries the only running commentary this page has —
     "Sending…", "404 Not Found in 312 ms", "Request failed" — and none of it
